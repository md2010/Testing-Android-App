...
public class TestAddingNewShift {
    ...
    @Test
    public void testAddingNewShift() throws Exception{
        MainPage mainPage = new MainPage(driver);
        mainPage.clickAddButton();

        AddNewShiftPage addNewShiftPage = new AddNewShiftPage(driver);
        addNewShiftPage.addNewRecord("29.12", "30", "8", "8:00-16:00", "240");
        addNewShiftPage.clickAddButton();

        Assert.assertEquals(mainPage.getSumFieldValue(), "240");
    }
